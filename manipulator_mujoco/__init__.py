...
register(
    id="manipulator_mujoco/AuboI5EnvDiff-v0",
    entry_point="manipulator_mujoco.envs:AuboI5EnvDiff",
    # Optionally, you can set a maximum number of steps per episode
    # max_episode_steps=300,
    # TODO: Uncomment the above line if you want to set a maximum episode step limit
)
...
register(
    id="manipulator_mujoco/AuboI5EnvVase-v0",
    entry_point="manipulator_mujoco.envs:AuboI5EnvVase",
    # Optionally, you can set a maximum number of steps per episode
    # max_episode_steps=300,
    # TODO: Uncomment the above line if you want to set a maximum episode step limit
)